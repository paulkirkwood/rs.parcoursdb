...
pub fn all () -> Vec<StageRace> {
    vec![tirreno_adriatico_2013(), tirreno_adriatico_2014(), tirreno_adriatico_2015(), tirreno_adriatico_2016()]
}

pub fn get(year:i32) -> Option<StageRace> {
    match year {
        2013 => Some(tirreno_adriatico_2013()),
        2014 => Some(tirreno_adriatico_2014()),
        2015 => Some(tirreno_adriatico_2015()),
        2016 => Some(tirreno_adriatico_2016()),
        _    => None
    }
}
